...
<template>
  ...
  <div
    style="display: flex; gap: 0.5rem; height: 460px; padding: 0.5rem"
    :style="[
      cardDirection === 'col'
        ? { 'flex-direction': 'column' }
        : { 'flex-direction': 'row' },
      cardStyleStore.cardBgActive
        ? { 'background-color': cardStyleStore.cardBg }
        : {},
      cardStyleStore.border
        ? { border: '1px solid ' + cardStyleStore.borderColor }
        : {},
    ]"
  >
  <!-- img container -->

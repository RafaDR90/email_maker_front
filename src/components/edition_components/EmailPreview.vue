    ...
    <div id="emailContainer" style="
      ...
      <div style="border: 1px solid rgb(230, 230, 230)">
        ...
        <div id="emailContent" style="
          ...
          <!-- Top Banner -->
          <a v-if="!documentActionsStore.creatingSvg && !documentActionsStore.addProductModal" :href="bannerStore.topBannerUrl">
          <NewBanner  :bannerImageUrl="bannerStore.topImgBannerUrl"
          ...
          <div v-else-if="!documentActionsStore.creatingSvg && documentActionsStore.addProductModal">
          <NewBanner  :bannerImageUrl="bannerStore.topImgBannerUrl"
            :bannerBackgroundColor="bannerStore.bannerColor" :bannerBottomMargin="bannerStore.marginBottom"
            @click="updateSelectedBlock('banner')" class="selectable-block" >
          </NewBanner>
        ...
        <BottomSection v-if="!documentActionsStore.creatingSvg">
          <a v-if="!documentActionsStore.creatingSvg && !documentActionsStore.addProductModal" :href="bannerStore.bottomBannerUrl">
            <NewBanner class="selectable-block" :bannerImageUrl="bannerStore.bottomImgBannerUrl"
